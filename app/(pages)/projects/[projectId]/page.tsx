        ...
        <Engine projectId={id}>
            <div className="flex flex-col h-screen border-collapse">
                ...
                <div className="flex w-full h-[calc(100vh-248px)] ">
                    <div className="w-1/4 border-r-1 border-gray-300 dark:border-white border-collapse">
                        <ObjectHierarchy />
                    </div>
                    <div className="w-2/4 border-collapse">
                        <Canvas />
                    </div>
                    <div className="w-1/4 border-l-1 border-gray-300 dark:border-white border-collapse">
                        <Inspector />
                    </div>
                </div>
                <div className="w-full h-50 border-t-1 border-gray-300 dark:border-white border-collapse">
                    <div>
