...
export const ExplorerPanel = ({ project, path, changePath }: any) => {
    ...
    return (
        <div className="flex m-2 h-10 text-white w-[99%]">
            ...
            <button onClick={() => setIsFolderOpen(true)} className="flex border-r-2 border-white justify-center items-center h-full w-15 bg-green-600 
            ...
            <button onClick={() => setIsFileOpen(true)} className="flex rounded-tr-2xl rounded-br-2xl justify-center items-center h-full w-15 bg-green-600 
            hover:bg-green-800 transition-colors duration-300">
