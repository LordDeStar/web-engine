...
export const CreateFileModal = ({ project, parent, onClose }: any) => {
    ...
    return (
        <div className='fixed flex justify-center items-center top-0 left-0 h-screen w-screen z-10'>
            ...
            <div className="z-11 w-[30%] rounded-2xl flex flex-col gap-2.5 bg-gray-300 dark:bg-neutral-600 p-2.5">
                <button
                ...
                <div
                    ...
                    onDrop={handleDrop}
                    className='flex justify-center items-center h-[10vh] bg-gray-500 dark:bg-neutral-800 rounded-2xl border-dashed border-5 border-neutral-600 dark:border-neutral-900' >
                    <h1 className="text-2xl w-fit flex justify-center text-white items-center">Перетащите файл сюда</h1>
                </div>
